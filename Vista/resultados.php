    ...
    <form action="index.php?action=listaResul" method="post">
        <div class="">
            ...
            if (empty($arrayResultados)) {
                ...
                $login_pa = htmlspecialchars($first[4] ?? '');
                ...
                echo "<th style='padding:8px;text-align:left;'>Identificador paciente (login_pa)</th>";
                echo "<th style='padding:8px;text-align:left;'>Centro/Responsable (login_sa)</th>";
                ...
                echo "<tr><th style='padding:8px;text-align:left;'>Prueba</th><th style='padding:8px;text-align:left;'>Resultados</th><th style='padding:8px;text-align:left;'>Valores normales</th><th style='padding:8px;text-align:left;'>Interpretación</th></tr>";
                ...
                foreach ($arrayResultados as $key => $value) {
                    ...
                    $interpret = htmlspecialchars($value[3] ?? '');
                    echo "<tr>";
                    ...
                    echo "<td style='padding:8px;border-top:1px solid #e5e7eb;'><input type='radio' name='nomUsu' value='".htmlspecialchars($value[1])."' required></td>";
                    echo "</tr>";
                }
            ...
            ?>
            <input type="submit" value="Modificar" name="modificar" style="margin-top:1rem;">
        </div>
    </form>
</main>
