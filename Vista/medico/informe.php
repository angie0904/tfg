...
<div class="max-w-4xl mx-auto p-6">
    <form method="post" action="index.php?action=guardarInfo">
          <div>
            <input id="nhc" name="nom" type="text-area" placeholder="Numero de historia clínica (NHC)"
                   class="w-full border border-black rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-400 h-32"
                   >
