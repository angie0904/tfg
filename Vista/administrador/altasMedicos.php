...
<div class="max-w-6xl mx-auto">
    <h1 class="text-3xl font-bold mb-6">Médicos</h1>
            ...
            <table class="min-w-full table-fixed border-collapse">
                <thead>
                    <tr class="bg-blue-600 text-white text-left">
                        <th class="sticky top-0 px-4 py-3 border">Nº Colegiado</th>
                        <th class="sticky top-0 px-4 py-3 border">Nombre</th>
                        <th class="sticky top-0 px-4 py-3 border">Apellidos</th>
                        <th class="sticky top-0 px-4 py-3 border">Especialidad</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="4" class="px-4 py-3 text-center text-gray-500">No hay médicos registrados</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
